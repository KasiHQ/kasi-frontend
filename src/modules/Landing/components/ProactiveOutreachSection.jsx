...
export const ProactiveOutreachSection = () => {
  return (
    <section id="proactive-outreach" className="w-full py-[100px] bg-[#1A7A4A] border-b border-[#15603A] relative select-none overflow-hidden">
      ...
      <div className="w-full max-w-[1200px] mx-auto px-4 md:px-6 relative z-10 text-center space-y-12">
        ...
        <div className="max-w-3xl mx-auto space-y-6 flex flex-col items-center">
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1 bg-white/10 border border-white/20 text-white text-xs font-bold uppercase tracking-wider rounded-full select-none shadow-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-[960px] mx-auto text-left pt-4">
          ...
          <div className="bg-black/25 border border-white/15 rounded-2xl p-8 flex flex-col gap-6 transition-all duration-300 hover:border-white/30 hover:-translate-y-1 shadow-sm hover:shadow-md">
            <div className="w-12 h-12 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center shrink-0 text-white shadow-xs">
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-8 flex flex-col gap-6 transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-1">
            <div className="w-12 h-12 rounded-xl bg-[#E8F5EE] border border-[#1A7A4A]/20 flex items-center justify-center shrink-0 text-[#1A7A4A] shadow-xs">
